import { e as createAstro, f as createComponent, k as renderComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute } from '../chunks/astro/server_Dc7gvlnh.mjs';
import 'kleur/colors';
import { $ as $$Layout, i as instagramIcon, t as tiktokIcon, p as pinterestIcon } from '../chunks/Layout_BQGi2GMQ.mjs';
...
S’inscrire
</button> </form> <!-- Réseaux sociaux --> <div class="flex justify-center space-x-6 mt-8"> <a href="#" target="_blank" rel="noopener noreferrer"> <img${addAttribute(instagramIcon.src, "src")} alt="Instagram" class="w-10 h-10"> </a> <a href="#" target="_blank" rel="noopener noreferrer"> <img${addAttribute(tiktokIcon.src, "src")} alt="TikTok" class="w-10 h-10"> </a> <a href="#" target="_blank" rel="noopener noreferrer"> <img${addAttribute(pinterestIcon.src, "src")} alt="Pinterest" class="w-10 h-10"> </a> </div> </div> </main> ` })}`;
