...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="relative bg-[var(--color-violet)] text-white min-h-screen flex flex-col items-center justify-center"> <img${addAttribute(landingImage.src, "src")} alt="" class="absolute top-0 left-0 w-full h-full object-cover opacity-60 min-h-screen"> <div class="absolute inset-0 bg-gradient-to-b from-[var(--color-violet)] via-transparent to-[var(--color-orange)] opacity-50"></div> <div class="relative z-10 text-center max-w-2xl px-4 -translate-y-10 md:-translate-y-16"> <h1 class="text-xl md:text-2xl lg:text-3xl font-bold text-[var(--color-orange)] mb-4">Bienvenue sur Fac'Link !</h1> <p class="text-base md:text-lg font-semibold mb-8" style="font-family: var(--font-Menu);">VOTRE CAMPUS EN UN CLIC, SUR FAC'LINK !</p> <div class="flex flex-col md:flex-row gap-4 w-full md:max-w-md"> <input type="email" placeholder="Ton email universitaire *" class="bg-[var(--color-violet)] text-white rounded-full px-6 py-3 focus:outline-none focus:ring-2 focus:ring-[var(--color-orange)]"> <button onclick="window.location.href='/inscription'" class="bg-gradient-to-r from-[var(--color-orange)] to-[var(--color-rose)] hover:from-pink-500 hover:to-orange-500 text-white rounded-full px-8 py-3 font-bold" style="font-family: var(--font-Menu);">Inscris-toi !</button> </div> <p class="text-sm mt-4" style="font-family: var(--font-Menu);">* accès uniquement avec un email universitaire valide</p> <div class="mt-8"> <img${addAttribute(fleche.src, "src")} alt="scroll down" class="mx-auto h-32 md:h-40 lg:h-48 opacity-100"> </div> </div> </div> <section class="bg-(--color-violet) text-white py-16 md:py-24 lg:py-32"> <div class="container mx-auto px-4"> <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-8" style="font-family: var(--font-Menu);">Qui sommes-nous ?</h2> <p class="text-lg text-center mb-8" style="font-family: var(--font-Menu);">
